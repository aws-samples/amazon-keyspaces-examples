...
const custom_retry = require('../AmazonKeyspacesRetryPolicy.js');
const RetryPolicy = cassandra.policies.retry.RetryPolicy;

describe('AmazonKeyspacesRetryPolicy', function () {
  describe('#onUnavailable()', function () {
    it('should retry on the same host for onUnavailable exception', function () {
      const policy = new custom_retry.AmazonKeyspacesRetryPolicy();
