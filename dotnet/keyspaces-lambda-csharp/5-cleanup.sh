...
rm -rf src/keyspaces-lambda-csharp/bin src/keyspaces-lambda-csharp/obj
rm -rf test/keyspaces-lambda-csharp.Tests/bin test/keyspaces-lambda-csharp.Tests/obj